...
export function createUpdateUserSettingsMutation(prisma) {
...
export function createUpdateUserProfileMutation(prisma) {
    return (async (_, args, ctx) => {
        const userId = requireUser(ctx);
...
export function createChangePasswordMutation(prisma) {
    return (async (_, args, ctx) => {
        const userId = requireUser(ctx);
