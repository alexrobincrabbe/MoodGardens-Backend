...
const resolvers = {
  ...
  Query: {
    garden: async (_parent: unknown, args: GardenArgs, _ctx: Context) => {
  ...
  Mutation: {
    ...
    requestGarden: async (_parent: unknown, args: GardenArgs, _ctx: Context) => {
      const { period, periodKey } = args;
