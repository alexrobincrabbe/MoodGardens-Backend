...
import { UNDERWATER_WEATHER } from "./underwaterWeather.js";
...
const WEATHER_MATRIX: Record<PrimaryEmotion, Record<NormalisedIntensity, string>> = {
    joy: {
...
export const WEATHER_MATRIX_BY_TYPE: Record<
  GardenType,
  Record<PrimaryEmotion, Record<NormalisedIntensity, string>>
> = {
  CLASSIC: WEATHER_MATRIX,
  UNDERWATER: UNDERWATER_WEATHER,
